Shader "lit/WallShader"
{
    Properties
    {
        _MainTex ("Main Texture", 2D) = "white" {}
        _NormalMap ("Main Texture", 2D) = "white" {}
        _AmbientOcclusionMap ("Main Texture", 2D) = "white" {}
    ...
    SubShader
    {
        ...
        Pass
        {
            ...
            half4 frag (v2f i) : SV_Target
            {
                ...
                float NdotL = 0.5 + 0.5 * dot(lightDir, i.normal); // NdotL로 간단히 라이팅한다.
